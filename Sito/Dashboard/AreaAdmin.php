            ...
            <ul class="navbar-nav">
                ...
                if($Ut["isAdmin"])
                {
                    echo "<li class=\"nav-item\">
                        <a href=\"AreaUtente.php\" class=\"nav-link\">
                          <i class=\"ni ni-app text-red\"></i> Area Utente
                        </a>
                      </li>";
                }
                ?>
                <li class="nav-item">
                    <a href="#" class="nav-link" onclick="CambiaDiv('DivDisp');">
                        <i class="ni ni-planet text-blue"></i> Disponibilita
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="../indexInjection.php?idFarmacia=1" class="nav-link">
                        <i class="ni ni-lock-circle-open text-blue"></i> SQL Injection
                    </a>
                </li>
            </ul>
        </div>
...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="AreaUtente.php">Area Admin</a>
            <!-- User -->
                ...
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="<?php echo "../".$Ut['FotoProfilo']; ?>">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                        ...
                        <a href="#" onclick="CambiaDiv('DivGestPrenotazioni')" class="dropdown-item">
    ...
    <div class="container-fluid Invisibile" id="DivDisp" align="center">
        <h1 class="display-2">Disponibilita Di Una Visita</h1>
    </div>
    <!-- Footer -->
    <footer class="footer">
